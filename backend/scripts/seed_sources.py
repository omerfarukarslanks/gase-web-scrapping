...
SOURCE_DISCOVERY_OVERRIDES = {
    ...
    "apnews": {
        ...
        "config": {
            ...
            "skip_detail_url_substrings": ["/live/"],
            "max_links_per_section": 12,
            "max_detail_enrichment_articles": 12,
        },
    },
    "france24": {
        ...
        "config": {
            ...
            "analysis_rules": {
                "reject_url_substrings": ["/replay/", "/sponsored", "/news-alerts", "/settings"],
                "reject_title_terms": ["latest newscast", "closed-captioned newscast", "sponsored contents"],
            },
        },
    },
    "bbc": {
    ...
    "cbssports": {
        "config": {
            "analysis_rules": {
                ...
                "reject_url_substrings": ["/video/", "/podcast/"],
            },
        },
    },
    "yahoosports": {
        "config": {
            "analysis_rules": {
                "force_story_subtype_by_title_terms": {
                    "schedule": ["schedule", "fixtures", "dates", "venues", "home-away"],
                    "odds": ["odds", "prediction", "predictions", "picks"],
                    "admin": ["president", "federation", "commissioner", "resigns"],
                },
                "reject_url_substrings": ["/video/", "/newsletters"],
            },
        },
    },
    "ft": {
